        ...
        <div className="container mx-auto px-4">
          ...
          <div className="md:hidden max-w-md mx-auto mb-6">
            ...
            <div className="relative">
              <select
                value={selectedLevel}
                onChange={(e) => setSelectedLevel(e.target.value as 'sd' | 'smp' | 'sma')}
                className="block w-full appearance-none rounded-lg border border-slate-300 bg-white px-3 py-2.5 pr-10 text-sm text-slate-800 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
              >
                <option value="sd">SD Tahfidz (Fullday)</option>
                <option value="smp">SMP Pondok Putri (Boarding)</option>
                <option value="sma">SMA Pondok Putri (Boarding)</option>
              </select>
              <ChevronDown className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />
            </div>
          </div>

          {/* Kartu jenjang - mobile (satu per pilihan) */}
          <div className="md:hidden max-w-md mx-auto">
            {selectedLevel === 'sd' && (
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-4 border-primary-500">
                <div className="p-6 text-center">
                  <div className="w-16 h-16 mx-auto bg-primary-50 text-primary-600 rounded-2xl flex items-center justify-center mb-4">
                    <BookOpen className="w-9 h-9" />
                  </div>
                  <h3 className="text-xl font-serif font-bold text-slate-900 mb-1.5">SD Tahfidz</h3>
                  <p className="text-slate-500 text-xs mb-4">Fullday School (Putra & Putri)</p>
                  <div className="text-left space-y-3 mb-6 text-xs">
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-slate-600">Usia 6-12 tahun</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Fullday school (07.30 - 15.30 WIB)</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Target hafalan 3-5 Juz</span>
                      </div>
                    </div>
                  </div>
                  <a
                    ...
                    className="block w-full bg-primary-600 hover:bg-primary-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 text-center text-sm"
                  >
                    Daftar SD Tahfidz
                  </a>
                </div>
            ...
            {selectedLevel === 'smp' && (
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-secondary-500 relative">
                <div className="absolute top-3 right-3 bg-secondary-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full">
                  PALING DIMINATI
                </div>
                <div className="p-6 text-center">
                  <div className="w-16 h-16 mx-auto bg-secondary-50 text-secondary-600 rounded-2xl flex items-center justify-center mb-4">
                    <Home className="w-9 h-9" />
                  </div>
                  <h3 className="text-xl font-serif font-bold text-slate-900 mb-1.5">SMP Pondok Putri</h3>
                  <p className="text-slate-500 text-xs mb-4">Boarding School (Khusus Putri)</p>
                  <div className="text-left space-y-3 mb-6 text-xs">
                    <p className="text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Lulusan SD/MI sederajat</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Boarding school full day</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Target hafalan 15 Juz</span>
                      </div>
                    </div>
                  </div>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full bg-secondary-500 hover:bg-secondary-600 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 text-center text-sm"
                  >
            ...
            {selectedLevel === 'sma' && (
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-4 border-slate-700">
                <div className="p-6 text-center">
                  <div className="w-16 h-16 mx-auto bg-slate-50 text-slate-600 rounded-2xl flex items-center justify-center mb-4">
                    <Users className="w-9 h-9" />
                  </div>
                  <h3 className="text-xl font-serif font-bold text-slate-900 mb-1.5">SMA Pondok Putri</h3>
                  <p className="text-slate-500 text-xs mb-4">Boarding School (Khusus Putri)</p>
                  <div className="text-left space-y-3 mb-6 text-xs">
                    <p className="text-slate-700 leading-relaxed">
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Lulusan SMP/MTs sederajat</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Boarding school full day</span>
                      ...
                      <div className="flex items-start gap-2">
                        <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-slate-600">Target hafalan 30 Juz</span>
                      </div>
                    </div>
                  </div>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full bg-slate-800 hover:bg-slate-900 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 text-center text-sm"
                  >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            {/* FAQ Item 2 */}
            <div className="border border-slate-200 rounded-xl overflow-hidden">
              <button className="w-full px-6 py-4 text-left flex items-center justify_between focus:outline-none">
